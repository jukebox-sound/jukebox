...
information about the plugin:
    ...
    desc   Plugin Description (e.g., Notifies of the playing song.)
...
changes in the playing song, you might use:
...
=item B<Playback Control Functions>
